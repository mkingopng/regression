...
Questions:
    - a) load the hitters data and remove the NA values
    - b) load the leaps package and use the `regsubsets()` and learn how to use
    ...
    variable model?
    - c) the `summary` function also returns R2, RSS, R2 adjusted Cp and BIC
