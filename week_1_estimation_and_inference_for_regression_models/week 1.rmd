...
If the random variable YY has the Gamma distribution with scale parameter ββ, which is the parameter of interest, and a known shape parameter αα, then its probability density function is:

f(y;β)=βαΓ(α)yα−1e−yβ.
f(y;β)=Γ(α)βα​yα−1e−yβ.
